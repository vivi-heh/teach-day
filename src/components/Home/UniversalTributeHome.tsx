...
export const UniversalTributeHome: React.FC<UniversalTributeHomeProps> = ({
  ...
  const handleToggleDedicationVoice = () => {
    ...
    if (isPlayingDedication) {
      ...
      const speechText =
        "Happy Teachers' Day 2026! To every educator, mentor, and guide: whether you teach mathematics, literature, sciences, the arts, languages, or guide first steps in primary learning — this tribute is dedicated to YOU. Teaching is the singular profession that creates all other professions. Thank you for your endless patience, your unwavering belief in our dreams, and the quiet sacrifices you make every single day. We honor and celebrate you!";
  ...
  const handleIncrementCounter = (type: 'apples' | 'hearts' | 'applause' | 'stars') => {
    playPopClick();
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      <section className="relative overflow-hidden bg-[#264653] neo-border neo-shadow p-6 sm:p-10 text-white grid-paper">
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-5">
          ...
          {/* Grand Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight italic font-sans text-white leading-tight">
            HAPPY <span className="text-[#E9C46A]">TEACHERS’</span> DAY 2026!
          </h1>

          {/* Sub-headline addressing any teacher without clicking */}
          <p className="text-base sm:text-lg text-white font-bold max-w-2xl mx-auto leading-relaxed">
          ...
          <p className="text-sm text-stone-200 max-w-2xl mx-auto leading-relaxed">
            Whether you teach Mathematics, Science, Literature, Arts, History, Languages, Music, or guide first steps in primary school: this tribute is dedicated to <strong className="text-[#E9C46A] underline decoration-2">YOU</strong>.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <button
              ...
              className="px-5 py-2.5 bg-[#E9C46A] hover:bg-[#ffe082] text-[#121212] font-black uppercase text-xs tracking-wider neo-border-2 neo-shadow transition-all cursor-pointer flex items-center gap-2 hover:translate-x-[1px] hover:translate-y-[1px]"
            >
            ...
            <button
              ...
              className={`px-5 py-2.5 font-black uppercase text-xs tracking-wider neo-border-2 neo-shadow transition-all cursor-pointer flex items-center gap-2 hover:translate-x-[1px] hover:translate-y-[1px] ${
                isPlayingDedication
            ...
            <button
              ...
              className="px-5 py-2.5 bg-[#E63946] hover:bg-[#d62839] text-white font-black uppercase text-xs tracking-wider neo-border-2 neo-shadow transition-all cursor-pointer flex items-center gap-2 hover:translate-x-[1px] hover:translate-y-[1px]"
            >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-[#E9C46A] neo-border-2 text-[10px] font-black uppercase tracking-wider mb-1">
              <span>★ Tap to Send Gratitude ★</span>
            </div>
            <h3 className="text-lg font-black uppercase tracking-tight text-[#121212]">
              Live Tribute Counter for Every Teacher
            </h3>
            <p className="text-xs text-[#121212]/80 font-medium">
              Click any token below to celebrate your mentors and add to the tribute!
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 w-full md:w-auto">
            <button
              ...
              className="px-4 py-2.5 bg-[#FFF3B0] hover:bg-[#ffe680] neo-border-2 neo-shadow-sm flex items-center justify-between gap-3 text-left cursor-pointer transition-all active:translate-y-[1px]"
            >
              <div className="text-2xl">🍎</div>
              <div>
                <div className="text-base font-black text-[#121212]">{liveCounters.apples.toLocaleString()}</div>
                <div className="text-[10px] font-bold uppercase text-[#121212]/80">Apples</div>
              </div>
            </button>
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#FFD166] hover:bg-[#ffc63a] neo-border-2 neo-shadow-sm flex items-center justify-between gap-3 text-left cursor-pointer transition-all active:translate-y-[1px]"
            >
              <div className="text-2xl">❤️</div>
              <div>
                <div className="text-base font-black text-[#121212]">{liveCounters.hearts.toLocaleString()}</div>
                <div className="text-[10px] font-bold uppercase text-[#121212]/80">Hearts</div>
              </div>
            </button>
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#A8DADC] hover:bg-[#91cfd2] neo-border-2 neo-shadow-sm flex items-center justify-between gap-3 text-left cursor-pointer transition-all active:translate-y-[1px]"
            >
              <div className="text-2xl">👏</div>
              <div>
                <div className="text-base font-black text-[#121212]">{liveCounters.applause.toLocaleString()}</div>
                <div className="text-[10px] font-bold uppercase text-[#121212]/80">Applauds</div>
              </div>
            </button>
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#F4A261] hover:bg-[#f18e40] neo-border-2 neo-shadow-sm flex items-center justify-between gap-3 text-left cursor-pointer transition-all active:translate-y-[1px]"
            >
              <div className="text-2xl">⭐</div>
              <div>
                <div className="text-base font-black text-[#121212]">{liveCounters.stars.toLocaleString()}</div>
                <div className="text-[10px] font-bold uppercase text-[#121212]/80">Stars</div>
              </div>
            </button>
          </div>
        </div>
      ...
      <section className="relative bg-[#FFFDF9] neo-border neo-shadow-lg p-6 sm:p-10 text-[#121212] space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b-2 border-[#121212]/15 pb-5">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-[#E63946] text-white neo-border-2 neo-shadow-sm flex items-center justify-center text-2xl font-black">
              🍎
            </div>
            <div>
      ...
      {/* 4. Universal Educator Laureates (4 Honors for Any Teacher to Claim) */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {laurelsList.map((laurel) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="text-4xl mb-2">{laurel.icon}</div>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-[#121212]/80 font-medium">
              Every message below is open, readable, and written directly for any teacher to enjoy.
            </p>
          </div>
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <span className="px-2.5 py-1 bg-[#E9C46A] neo-border-2 text-[10px] font-black uppercase tracking-wider text-[#121212]">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[#121212] leading-snug">
                    {card.headline}
                  </h3>

                  {/* The FULL Wish Message - 100% visible, crisp dark text, generous line height */}
                  <div className="mt-4 p-4 bg-[#F8F9FA] neo-border-2 space-y-3">
                    <p className="text-sm sm:text-base text-[#121212] font-normal leading-relaxed">
                      {card.message}
                    </p>

                    {card.favoriteQuote && (
                      <div className="pt-2 border-t border-[#121212]/15 text-xs sm:text-sm font-serif italic text-[#121212] font-semibold">
                        {card.favoriteQuote}
                      </div>
                    )}
                  </div>
                ...
                <div className="space-y-3 pt-2 border-t-2 border-[#121212]/15">
                  <div className="flex items-center justify-between text-xs font-black uppercase text-[#121212]">
                    ...
                    <span className="text-[11px] font-bold text-[#121212]/70">{card.senderRole}</span>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-white hover:bg-[#121212] hover:text-white text-[#121212] neo-border-2 text-xs font-black uppercase tracking-wider flex items-center gap-1 cursor-pointer transition-all"
                    >
      ...
      {/* 6. The 4 Cornerstones of Teaching */}
      <section className="bg-[#E9C46A] neo-border neo-shadow p-6 sm:p-8 text-[#121212]">
        <div className="text-center max-w-2xl mx-auto space-y-2 mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-[#121212]">
            The 4 Pillars of Every Great Teacher
          </h2>
          <p className="text-xs sm:text-sm text-[#121212]/85 font-medium">
            Qualities that make teachers the most unforgettable people in our lives.
          </p>
        </div>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-[#121212]/80 font-medium">
              Real, authentic appreciation notes written by students to teachers of all subjects.
            </p>
          </div>
